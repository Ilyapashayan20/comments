---
title: Multi-tenancy
description: Isolate comments per tenant with automatic query scoping and zero boilerplate.
navigation:
  icon: i-lucide-building-2
seo:
  description: Enable multi-tenancy in the Comments package to isolate data per tenant.
---
